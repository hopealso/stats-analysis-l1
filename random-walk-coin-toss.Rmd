...
```{r cor-1}
# Download Week1_Correlation_Comparison_Project_Data.csv sample file to working 
#   directory of r project to run this code:
Correlation.Data<-read.csv(file='Week1_Correlation_Comparison_Project_Data.csv',
                           header=TRUE,sep=",")
Correlation.Data[1:10,]

# Plot the simulated pairs of samples
par(mfrow=c(2,2))
...
# Write result to file in working directory of project
result <- data.frame(sdX=sd.X, sdY=sd.Y, cXY=cor.XY, a=a)
